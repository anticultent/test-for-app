    ...
    <div style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 14px 10px", flexShrink: 0 }}>
        <div style={{ display: "flex", gap: 8 }}>
          {allHosts.map((h, i) => (
            <GelCard
              ...
              style={{ ...videoStyle, flex: 1, height: 96, borderRadius: 12, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: 8 }}
            >
              <div style={{ position: "absolute", top: 6, left: 6, zIndex: 1, display: "flex", alignItems: "center", gap: 3, background: "rgba(0,0,0,0.32)", borderRadius: 4, padding: "2px 5px" }}>
                {vocalFx.length ? <Mic size={9} color="#fff" /> : <MicOff size={9} color="#fff" />}
              </div>
              <span style={{ position: "relative", zIndex: 1, fontFamily: "Inter", fontSize: 11, fontWeight: 700, color: "#0D0B14" }}>
                {h === "you" ? "You" : h}
              </span>
            </GelCard>
          ))}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 3 }}>
          ...
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10.5, color: "#948FA3" }}>{fmtNum(viewers)} watching</span>
        ...
        {tab === "fx" && (
          <div style={{ padding: "8px 16px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
              ...
              <p style={{ ...sectionLabel, margin: 0 }}>VOCAL FX</p>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
              ...
              <p style={{ ...sectionLabel, margin: 0 }}>VIDEO FX</p>
            </div>
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              {VIDEO_FX.map((fx) => (
            ...
            <p style={{ fontFamily: "Inter", fontSize: 11.5, color: "#948FA3", margin: "16px 0 0" }}>
              FX apply to the whole stream and show as badges to viewers.
            </p>
          </div>
        )}
